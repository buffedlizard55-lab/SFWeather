...
python3 tests/falsify_guards.py     # ledger guards can fail (105 cases)
npm test                            # render the page in jsdom (needs: npm install)
python3 tests/falsify_smoke.py      # render guards can fail (56 cases)
