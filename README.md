...
the official outlook incl. CPC's own verbatim caveats, the ranked cost drivers,
...
claims (71 checks) with their evidence, and *Irregularities* lists anything the
...
python3 pipeline/verify_claims.py               # the claim ledger (71 checks)
