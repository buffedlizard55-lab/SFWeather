...
python3 tests/test_parsers.py       # offline unit tests (473-474 assertions; see the table)
python3 tests/falsify_guards.py     # ledger guards can fail (85 cases)
npm test                            # render the page in jsdom (needs: npm install)
python3 tests/falsify_smoke.py      # render guards can fail (42 cases)
