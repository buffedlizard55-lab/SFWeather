...
claims (73 checks) with their evidence, and *Irregularities* lists anything the
...
python3 pipeline/verify_claims.py               # the claim ledger (73 checks)

python3 tests/test_parsers.py       # offline unit tests (449-450 assertions; see the table)
python3 tests/falsify_guards.py     # ledger guards can fail (77 cases)
npm test                            # render the page in jsdom (needs: npm install)
python3 tests/falsify_smoke.py      # render guards can fail (33 cases)
