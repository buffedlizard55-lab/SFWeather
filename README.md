...
tests/falsify_guards.py     proves each ledger guard can fail (19 mutated fixtures)
...
python3 tests/falsify_guards.py     # ledger guards can fail (19 cases)
