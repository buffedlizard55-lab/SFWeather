...
claims (70 checks) with their evidence, and *Irregularities* lists anything the
...
tests/falsify_guards.py     proves each ledger guard can fail (63 mutated fixtures)
tests/falsify_smoke.py      proves each render guard can fail (27 mutated copies)
...
python3 pipeline/verify_claims.py               # the claim ledger (70 checks)
